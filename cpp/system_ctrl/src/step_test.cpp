...
int main(int ac, char* av[]) {
    ...
    */
    ...
    Sequence sequence;
    sequence.push_back(0, 4000); //start at 4000, after getting there provide a 10 second resting time for the system
    sequence.push_back(10, 12000); //at 10 seconds, send a step signal to 12000
